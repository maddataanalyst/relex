...
if __name__ == "__main__":
    ...
    actor_net = pinets.DeterministicPolicyNet(a_dim, h_sizes=policy_arch, h_act=policy_act_f, out_act=out_act_f,
                                              out_initializer=out_initializer, hidden_initializer=h_initializer, a_max=h)
    ...
    agent = ddpg.DDPG(actor_net, actor_net_target, critic, critic_target, buffer, l, h, opt, target_update_frequency=1, polyak_tau=0.001)
    agent_hyperparams = {
