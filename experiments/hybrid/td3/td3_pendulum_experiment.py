...
import src.algorithms.hybrid.tf2.td3 as td3
...
EXPERIMENT_NAME = "TD3 pendulum"

if __name__ == "__main__":
    log = utils.prepare_default_log()
    model_name_abbrev = f'td3'
    ...
    critic2 = q_nets.QSANet(s_dim, a_dim, critic_arch_shared, critic_arch_a_sizes, critic_arch_s_sizes,
                           h_act=critic_h_act, out_act=critic_out_act)
    critic_target2 = q_nets.QSANet(s_dim, a_dim, critic_arch_shared, critic_arch_a_sizes, critic_arch_s_sizes,
                                  h_act=critic_h_act, out_act=critic_out_act)
    ...
    agent = td3.TD3(actor_net, actor_net_target, critic, critic_target, critic2, critic_target2, buffer, l, h, actor_optimizer=actor_opt,
