...
EXPERIMENT_NAME = "PPO discrete projects optimization"
ENV_SIZE = 300
...
if __name__ == "__main__":
    ...
    policy_net = policy_nets.DiscretePolicyNet(
        ...
        out_initializer=krs.initializers.GlorotNormal(seed=789))

    value_act_f = 'tanh'
    value_out_act_f = 'tanh'
    value_arch = [128, 128]
    value_initializer = krs.initializers.GlorotNormal(seed=456)
    ...
    agent = ppo.PPO(policy_net, value_net, policy_opt=policy_opt, value_opt=value_opt, advantage=advantage,
                          entropy_coef=entropy, n_agents=n_agents, clipping_eps=clipping_eps)
